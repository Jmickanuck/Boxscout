import { variantData } from '../data/fixtures/generated/golden-product-variants.ts';
import { cards } from '../data/fixtures/generated/golden-product-base.ts';
import { cardImageRepository } from './card-image-repository.ts';
import type { BrowseData, ChecklistEntry } from '../types/variants.ts';
export const releaseEntries:readonly ChecklistEntry[]=[...cards.map(c=>({...c,entryType:'BASE' as const,variationOfEntryId:null})),...variantData.entries];
