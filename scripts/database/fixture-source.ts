...
import {expandedVariants} from '../checklists/mega.ts';
import type {CatalogueDataRepository} from '../../src/types/publication.ts';
export const fixtureSource:CatalogueDataRepository={async read(){const variantData=expandedVariants();return structuredClone({
